...
static void gMonitoring_sendMonitoring()
{
	...
	gMonitoring.aDataString[69] = (Int16)(gAttitudeSensors.aGyro_X_rads*1000) >>8; //Transmit as milli-rad/s
	gMonitoring.aDataString[70] = (Int16)(gAttitudeSensors.aGyro_X_rads*1000) & 0xFF;
	gMonitoring.aDataString[71] = (Int16)(gAttitudeSensors.aGyro_Y_rads*1000) >>8;
	gMonitoring.aDataString[72] = (Int16)(gAttitudeSensors.aGyro_Y_rads*1000) & 0xFF;
	gMonitoring.aDataString[73] = (Int16)(gAttitudeSensors.aGyro_Z_rads*1000) >>8;
	gMonitoring.aDataString[74] = (Int16)(gAttitudeSensors.aGyro_Z_rads*1000) & 0xFF;
